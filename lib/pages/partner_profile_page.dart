            ...
            children: [
              ...
              Container(
                  ...
                  child: Column(children:[
                    ...
                    Text("We are a Pan-African business consultancy firm established in 2015. We provide Business Consultancy Services to MSMEs to enable them to leverage their business potentials through the use of digital transition infrastructure for Business Development, Sales, Marketing, Operations, Finance and Administration.",style:TextStyle(color:Colors.white)),
                    Divider(height:10,color:Colors.white),
                  ])
